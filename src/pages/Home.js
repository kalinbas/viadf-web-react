    ...
    render() {
        return (
            <Segment basic vertical>
                <Helmet>
                    <title>¿Cómo llegar en transporte público? - Ciudad de México | ViaDF</title>
                    <meta name="description" content="Busca conexiones de toda la red del Metro, Metrobús, Tren Ligero, Trolebús, RTP, Autobús, Microbús, Pesero, Pumabús y Tren Suburbano." />
                    ...
                    <Grid.Row>
                        <Grid.Column width={5}>
                            ...
                            <p style={{ fontSize: '1.33em' }}>
                                En ViaDF podrás encontrar la mejor forma de transportarte alrededor de la Ciudad de México, utilizando las principales conexiones como: Metro, Metrobús, Tren Ligero, Trolebús, RTP, Autobús, Microbús / Pesero, Mexibús, Pumabús y Tren Suburbano.
                            </p>
                        </Grid.Column>
                        <Grid.Column width={5}>
